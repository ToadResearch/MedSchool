...
1. *“Find **possible CKD** in **Patient 1126**: pull creatinine and eGFR observations, confirm code meanings via **LOINC lookup**, then summarize whether they meet **CKD stage 3** thresholds.”*
